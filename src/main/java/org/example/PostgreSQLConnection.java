...
//    }
    ...
    public void select(String table, String columns){
        ...
        System.out.println(getResults("SELECT " + columns + " FROM \"" + table+"\" ORDER BY \"ID\""));
    }

    public void insert(String table, String columns, String data1, String data2){
          //INSERT INTO public."USER" (first_name, last_name) VALUES ('zemene2', 'an2');
            String query = "INSERT INTO public.\""+table+"\"("+columns+") VALUES ('"+data1+"', '"+data2+"')";
            String res = getResults(query);
    }
    public void update(String table, String column, String data, String column_condition, String data_condition){
         String res = getResults("UPDATE \"" + table +"\" SET \""+column+"\" = \'" + data +
                "\' WHERE \""+column_condition+"\" = \'" + data_condition + "\'");
